...
print("data['signal']['chest'].keys():",data['signal']['chest'].keys())  
# data['signal']['chest'].keys(): dict_keys(['ACC', 'ECG', 'EMG', 'EDA', 'Temp', 'Resp'])
print("data['signal']['wrist'].keys():",data['signal']['wrist'].keys())  
# data['signal']['wrist'].keys(): dict_keys(['ACC', 'BVP', 'EDA', 'TEMP'])
...
print(data["label"])  # dict_keys(['arousal', 'valence'])
